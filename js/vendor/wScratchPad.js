...
//        this.ctx.setLineDash([1, 1]);
        this.ctx.shadowColor = 'rgba(0, 0, 255, .6)';;
...
//      this.ctx.lineTo((e.pageX+50),(e.pageY+50));
        this.ctx.lineTo((e.pageX-10),(e.pageY-10));
        this.ctx.lineTo(e.pageX, e.pageY);
//  this.ctx.lineTo(75, 5);
//  this.ctx.lineTo(115, 45);
//  this.ctx.lineTo(155, 5);
      this.ctx.stroke();
    },
